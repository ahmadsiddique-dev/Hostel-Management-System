...
const { registerStudent, getStudents, getStudentById, updateStudent, deleteStudent, createRoom, getRooms, markAttendance, sendNotification, getAllComplaints, updateComplaintStatus, getDashboardStats } = require('../controllers/managerController');
