...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 pb-10 px-4 sm:px-6 bg-gradient-to-b from-black via-zinc-950 to-black">
      {/* Animated Background */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="hero-content space-y-8 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-gray-200">The Future of Hostel Management</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Button size="lg" variant="outline" className="h-14 px-8 text-lg rounded-full border-white/20 text-white hover:bg-white/10 backdrop-blur-sm">
                Watch Demo
              </Button>
            </div>
          ...
          {/* <div className="relative h-[500px] lg:h-[600px] hidden lg:flex items-center justify-center">
            <div className="building-float relative w-full h-full flex items-center justify-center">
               <img 
                src="/hero-house.png" 
                alt="Futuristic Hostel" 
                className="w-full h-full object-contain drop-shadow-[0_0_50px_rgba(99,102,241,0.3)] mix-blend-lighten [mask-image:radial-gradient(ellipse_at_center,black_60%,transparent_100%)]"
              />
            </div>
          </div> */}
        </div>
